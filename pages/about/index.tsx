         ...
         >
            ...
            <div className="mt-4 md:flex-row flex-col justify-center text-justify">
               <div className="mx-2 mr-6 flex-1 font-medium ">
                  ...
                  />
                  VRC is a team for students who are joining robotics for the
                  first time because of its focus on kit parts. Currently,
                  BroncoBotics has 2 VRC teams, 201A and 201B. VEX is a new
                  program that we are very happy with. Congrats to Team 201A who
                  made it to States!
               </div>
               <div className="mx-2 flex-1 font-medium">
                  ...
                  robotics. Because of FTC&apos;s unique use of both kit parts
                  and custom parts, it is the perfect competition to prepare our
               ...
               <div className="mx-2 ml-6 flex-1  font-medium">
                  ...
                  Brophy&apos;s Innovation Commons. FRC is made up of Juniors
                  and Seniors who have lots of experience from their past years
                  in robotics. Currently, Broncobotics has 1 FRC team, team 991.
               </div>
            </div>
         </div>
         <Footer />
