...
const Navbar = (props: NavbarProps) => {
  ...
  let competitionsClass =
    props.currentPage === "competitions" ? choosePage + defaulClassName : defaulClassName + otherPage;
  ...
  let homeClass =
    props.currentPage === "home"
      ? "self-center text-xl font-semibold whitespace-nowrap -ml-2".concat(choosePage)
      : "self-center text-xl font-semibold whitespace-nowrap -ml-2".concat(otherPage);
      ...
      <nav className='px-1 sm:px-4 py-2.5 bg-inherit'>
        <div className='container flex flex-wrap justify-between items-center mx-auto'>
          <a href='/#' className='flex items-center'>
            ...
            <span className={homeClass} style={{ fontFamily: "DM Serif Text" }}>
              BroncoBotics
            </span>
          </a>
          <button
          ...
          <div className='hidden w-full md:block md:w-auto' id='mobile-menu'>
            <ul className='flex flex-col mt-4 md:flex-row md:space-x-4 md:mt-0 md:text-sm md:font-medium font-semibold'>
              <li>
                <a href='/about' className={aboutClass} style={{ fontFamily: "DM Serif Text" }}>
                  About Broncobotics
                </a>
              </li>
              <li>
                <a href='/robots' className={robotsClass} style={{ fontFamily: "DM Serif Text" }}>
                  Our Robots
                </a>
              </li>
              <li>
                <a href='/socials' className={photosClass} style={{ fontFamily: "DM Serif Text" }}>
                  Social Media
                </a>
              </li>
              <li>
                <a href='/brophy' className={brophyClass} style={{ fontFamily: "DM Serif Text" }}>
                  About Our School
                </a>
              </li>
            </ul>
